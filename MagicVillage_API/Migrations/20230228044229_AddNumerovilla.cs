    ...
    public partial class AddNumerovilla : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaAcutalizacion = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "FechaActualizacion", "FechaCreacion" },
                values: new object[] { new DateTime(2023, 2, 25, 16, 4, 38, 453, DateTimeKind.Local).AddTicks(6073), new DateTime(2023, 2, 25, 16, 4, 38, 453, DateTimeKind.Local).AddTicks(6052) });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "FechaActualizacion", "FechaCreacion" },
                values: new object[] { new DateTime(2023, 2, 25, 16, 4, 38, 453, DateTimeKind.Local).AddTicks(6080), new DateTime(2023, 2, 25, 16, 4, 38, 453, DateTimeKind.Local).AddTicks(6078) });
        }
    }
}
